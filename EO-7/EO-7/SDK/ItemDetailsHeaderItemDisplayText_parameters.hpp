...
public:
	...
	enum class EFortRarity                       CallFunc_GetRarity_ReturnValue;                    // 0x1A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class ESlateVisibility                  K2Node_Select_Default;                             // 0xFB(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
