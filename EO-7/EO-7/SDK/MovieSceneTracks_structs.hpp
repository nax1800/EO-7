...
public:
	...
	uint8                                        Pad_18D7[0x4C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_18D8[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_18D9[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVector                               Location;                                          // 0x8(0xC)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_18DA[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_18DE[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18DF[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18E4[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_18E8[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	struct FRichCurve                            TranslationCurve[0x3];                             // 0x18(0x150)(NativeAccessSpecifierPublic)
	struct FRichCurve                            RotationCurve[0x3];                                // 0x168(0x150)(NativeAccessSpecifierPublic)
	struct FRichCurve                            ScaleCurve[0x3];                                   // 0x2B8(0x150)(NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FRichCurve                            Curves[0x4];                                       // 0x30(0x1C0)(NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FRichCurve                            ComponentCurves[0x4];                              // 0x38(0x1C0)(Protected, NativeAccessSpecifierProtected)
