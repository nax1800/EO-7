...
void UTabGameOptionsMain_C::Initialize_Data(const TArray<class FText>& OffOnOptions, TArray<class FText>& CallFunc_GetRegionDisplayNames_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue2, class FText CallFunc_MakeLiteralText_ReturnValue3, class FText CallFunc_MakeLiteralText_ReturnValue4, class FText CallFunc_MakeLiteralText_ReturnValue5, class FText CallFunc_MakeLiteralText_ReturnValue6, class FText CallFunc_MakeLiteralText_ReturnValue7, TArray<class FText>& K2Node_MakeArray_Array, bool CallFunc_IsPS4Platform_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue8, class FText CallFunc_MakeLiteralText_ReturnValue9, class FText CallFunc_MakeLiteralText_ReturnValue10, class FText CallFunc_MakeLiteralText_ReturnValue11, TArray<class FText>& CallFunc_GetPossibleLanguages_ReturnValue, class FText Temp_text_Variable, class FText CallFunc_MakeLiteralText_ReturnValue12, class FText CallFunc_MakeLiteralText_ReturnValue13, class FText CallFunc_MakeLiteralText_ReturnValue14, class FText CallFunc_MakeLiteralText_ReturnValue15, class FText CallFunc_MakeLiteralText_ReturnValue16, class FText CallFunc_MakeLiteralText_ReturnValue17, class FText CallFunc_MakeLiteralText_ReturnValue18, class FText CallFunc_MakeLiteralText_ReturnValue19, class FText CallFunc_MakeLiteralText_ReturnValue20, class FText Temp_text_Variable2, class FText CallFunc_MakeLiteralText_ReturnValue21, bool Temp_bool_Variable, class FText K2Node_Select_Default, class FText CallFunc_MakeLiteralText_ReturnValue22, class FText CallFunc_MakeLiteralText_ReturnValue23, class FText CallFunc_MakeLiteralText_ReturnValue24, class FText CallFunc_MakeLiteralText_ReturnValue25)
{
...
// enum class ESlateVisibility        K2Node_Select10_Default                                          (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UTabGameOptionsMain_C::Update_Data(enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable2, class UFortHomebaseUIContext* CallFunc_GetContext_ReturnValue, class UFortHomebaseUIContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_GetShowHeroBackpackForLocalPlayer_ReturnValue, bool CallFunc_GetShowHeroHeadAccessoriesForLocalPlayer_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue2, bool Temp_bool_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable2, bool Temp_bool_Variable2, class FText Temp_text_Variable3, class FText Temp_text_Variable4, bool Temp_bool_Variable3, class FText Temp_text_Variable5, class FText Temp_text_Variable6, bool Temp_bool_Variable4, class FText Temp_text_Variable7, class FText Temp_text_Variable8, bool Temp_bool_Variable5, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility Temp_byte_Variable4, bool Temp_bool_Variable6, enum class ESlateVisibility Temp_byte_Variable5, enum class ESlateVisibility Temp_byte_Variable6, bool Temp_bool_Variable7, enum class ESlateVisibility Temp_byte_Variable7, enum class ESlateVisibility Temp_byte_Variable8, bool Temp_bool_Variable8, enum class ESlateVisibility Temp_byte_Variable9, enum class ESlateVisibility Temp_byte_Variable10, float CallFunc_GetGamepadScopedMultiplierValue_ReturnValue, float CallFunc_GetGamepadTargetingMultiplierValue_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue2, class FText CallFunc_MakeLiteralText_ReturnValue3, class FText CallFunc_MakeLiteralText_ReturnValue4, bool CallFunc_IsXboxPlatform_ReturnValue, bool CallFunc_GetTargetingToggleState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue3, float CallFunc_GetScopedMultiplierValue_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue5, class FText CallFunc_MakeLiteralText_ReturnValue6, float CallFunc_GetTargetingMultiplierValue_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue7, class FText CallFunc_MakeLiteralText_ReturnValue8, bool CallFunc_IsAthena_ReturnValue, int32 CallFunc_GetCurrentRegion_ReturnValue, bool Temp_bool_Variable9, bool CallFunc_IsAthena_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable11, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_IsPS4Platform_ReturnValue, bool CallFunc_IsPS4Platform_ReturnValue2, class FText K2Node_Select2_Default, class FText K2Node_Select3_Default, class FText K2Node_Select4_Default, class FText K2Node_Select5_Default, bool CallFunc_GetTapInteractState_ReturnValue, bool CallFunc_GetFocusOnFirstBuildingPieceWhenQuickbarSwappedState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue4, int32 CallFunc_Conv_BoolToInt_ReturnValue5, bool CallFunc_IsPS4Platform_ReturnValue3, bool CallFunc_IsXboxPlatform_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_ShouldShowSafeZoneOption_ReturnValue, enum class ESlateVisibility K2Node_Select6_Default, enum class ESlateVisibility K2Node_Select7_Default, enum class ESlateVisibility K2Node_Select8_Default, enum class ESlateVisibility K2Node_Select9_Default, enum class ESlateVisibility Temp_byte_Variable12, int32 CallFunc_GetCurrentLanguage_ReturnValue, float CallFunc_GetSafeZoneValue_ReturnValue, bool CallFunc_GetSprintCancelsReloadState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue6, class FText CallFunc_MakeLiteralText_ReturnValue9, class FText CallFunc_MakeLiteralText_ReturnValue10, class FText CallFunc_MakeLiteralText_ReturnValue11, bool CallFunc_GetForceFeedbackState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue7, bool Temp_bool_Variable10, const struct FVector2D& CallFunc_GetGamepadLookSensitivityValue_ReturnValue, enum class ESlateVisibility K2Node_Select10_Default, float CallFunc_BreakVector2D_X, float CallFunc_BreakVector2D_Y, bool CallFunc_GetLookInversionState_ReturnValue, bool CallFunc_GetFirstPersonCameraState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue8, int32 CallFunc_Conv_BoolToInt_ReturnValue9, bool CallFunc_GetAutoEquipState_ReturnValue, bool CallFunc_GetSprintToggleState_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue10, int32 CallFunc_Conv_BoolToInt_ReturnValue11, float CallFunc_GetMouseSensitivityValue_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue12)
{
