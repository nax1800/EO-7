...
{
public:
	struct FMaterialQualityOverrides             QualityOverrides[0x3];                             // 0x28(0x12)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2171[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
