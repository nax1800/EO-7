...
public:
	...
	uint8                                        Pad_1AC7[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1ACB[0x2B];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1AD0[0x488];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1AD1[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AD5[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
