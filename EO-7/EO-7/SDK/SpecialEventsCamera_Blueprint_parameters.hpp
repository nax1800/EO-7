...
public:
	...
	class ABP_FortniteLobbyLightSwitcher_C*      CallFunc_Array_Get_Item;                           // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors2;           // 0x38(0x10)(ZeroConstructor, ReferenceParm)
	...
	class ATVPostProcessBP_C*                    CallFunc_Array_Get_Item2;                          // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
