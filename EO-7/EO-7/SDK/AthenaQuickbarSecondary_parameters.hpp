...
{
public:
	class FString                                ConfigF;                                           // 0x0(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash)
	class FString                                ConfigE;                                           // 0x10(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash)
	bool                                         IsConfigE;                                         // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         IsConfigF;                                         // 0x21(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FString                                CallFunc_GetCurrentInputPresetName_ReturnValue;    // 0x58(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_GetCurrentInputPresetName_ReturnValue2;   // 0x68(0x10)(ZeroConstructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_StrStr_ReturnValue;            // 0x78(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_StrStr_ReturnValue2;           // 0x79(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
{
public:
	class FString                                ConfigE;                                           // 0x0(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash)
	class FString                                ConfigF;                                           // 0x10(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash)
	bool                                         IsConfigE;                                         // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         IsConfigF;                                         // 0x21(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	TArray<class UQuickbarSlot_C*>               K2Node_MakeArray_Array;                            // 0x38(0x10)(ZeroConstructor, ReferenceParm)
