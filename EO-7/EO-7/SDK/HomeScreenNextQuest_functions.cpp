...
void UHomeScreenNextQuest_C::ExecuteUbergraph_HomeScreenNextQuest(int32 EntryPoint, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue, TArray<class FString>& K2Node_CustomEvent_ActiveEventFlags, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_UpdateButtonBasedOnEventStatus_EventIsActive, bool CallFunc_UpdateButtonBasedOnEventStatus_EventIsActive2, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue3, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue4, int32 CallFunc_GetActiveWidgetIndex_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
