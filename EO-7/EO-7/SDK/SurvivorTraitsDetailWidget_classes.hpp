...
public:
	...
	void ExecuteUbergraph_SurvivorTraitsDetailWidget(int32 EntryPoint, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable2, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility Temp_byte_Variable4, bool Temp_bool_Variable2, class FText Temp_text_Variable, class FText Temp_text_Variable2, bool Temp_bool_Variable3, bool Temp_bool_Variable4, class FText Temp_text_Variable3, class UFortHero* K2Node_DynamicCast_AsFort_Hero, bool K2Node_DynamicCast_bSuccess, class UFortWorker* K2Node_DynamicCast_AsFort_Worker, bool K2Node_DynamicCast_bSuccess2, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, TArray<struct FGameplayTag>& CallFunc_BreakGameplayTagContainer_GameplayTags, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, class FText Temp_text_Variable4, class FText K2Node_Select_Default, bool CallFunc_IsTemporaryItem_ReturnValue, bool Temp_bool_Variable5, bool CallFunc_IsValid_ReturnValue, enum class ESlateVisibility Temp_byte_Variable5, enum class EFortInventoryFilter CallFunc_GetFilterCategory_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, enum class ESlateVisibility Temp_byte_Variable6, class FText K2Node_Select2_Default, enum class ESlateVisibility K2Node_Select3_Default, bool CallFunc_Not_PreBool_ReturnValue2, enum class ESlateVisibility K2Node_Select4_Default, enum class ESlateVisibility K2Node_Select5_Default);
};
