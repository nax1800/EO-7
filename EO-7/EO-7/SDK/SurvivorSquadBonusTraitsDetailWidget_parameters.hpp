...
public:
	...
	uint8                                        Pad_22DD[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x131(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x132(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x133(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSlateBrush                           K2Node_Select4_Default;                            // 0x168(0x90)(ConstParm)
	bool                                         CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0x1F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_22E1[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UClass*                                K2Node_Select5_Default;                            // 0x200(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
