...
{
public:
	uint8                                        Pad_1C2D[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1C2F[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1C30[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FRichCurve                            Translation[0x2];                                  // 0x38(0xE0)(NativeAccessSpecifierPrivate)
	struct FRichCurve                            Rotation;                                          // 0x118(0x70)(NativeAccessSpecifierPrivate)
	struct FRichCurve                            Scale[0x2];                                        // 0x188(0xE0)(NativeAccessSpecifierPrivate)
	struct FRichCurve                            Shear[0x2];                                        // 0x268(0xE0)(NativeAccessSpecifierPrivate)
};
