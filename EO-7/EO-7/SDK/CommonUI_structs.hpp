...
public:
	...
	struct FKey                                  PlatformSpecificKeys[0x4];                         // 0x20(0x60)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EInputActionState                 OverrrideStateForInputType[0x4];                   // 0x80(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_22BA[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           InputTypeOverrideBrush[0x4];                       // 0x88(0x240)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FSlateBrush                           PlatformSpecificBrush[0x4];                        // 0x0(0x240)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_22BD[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
