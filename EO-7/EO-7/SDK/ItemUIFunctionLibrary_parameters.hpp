...
public:
	...
	struct FTooltipStat                          K2Node_MakeStruct_TooltipStat;                     // 0x1F0(0x31)(HasGetValueTypeHash)
	uint8                                        Pad_33DF[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTooltipStat                          K2Node_MakeStruct_TooltipStat2;                    // 0x228(0x31)(HasGetValueTypeHash)
