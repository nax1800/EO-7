...
public:
	...
	uint8                                        Pad_3657[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  CallFunc_GetShortDescription_ShortDescription2;    // 0x50(0x18)()
	bool                                         CallFunc_GetShortDescription_ReturnValue2;         // 0x68(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_365D[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3670[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
