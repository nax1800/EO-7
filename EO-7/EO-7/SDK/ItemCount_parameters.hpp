...
{
public:
	enum class EFortBrushSize                    InBrushSize;                                       // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_30BD[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UClass*                                InStyle;                                           // 0x8(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	int32                                        OverrrideValue;                                    // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x16(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x43(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
